        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <Accordion type="single" collapsible className="space-y-4">
            ...
            <AccordionItem value="item-6" className="bg-white rounded-lg px-6 border">
              ...
              <AccordionContent className="text-muted-foreground">
                GX2Invest берет плату только за фактическое управление инвестиционным счетом, то есть, только после его пополнения денежными средствами или ценными бумагами. Плата за управление составляет 1% годовых от средневзвешенной суммы внесенных активов (минимум 30 000 руб. в год).
              </AccordionContent>
            </AccordionItem>
