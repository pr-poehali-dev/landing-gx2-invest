          ...
          {benefits.map((benefit, index) => {
            const content = (
              <>
                ...
                <h3 className={`text-base sm:text-lg font-semibold mb-2 text-secondary group-hover:text-primary transition-colors ${benefit.link ? 'underline decoration-transparent group-hover:decoration-primary' : ''}`}>
                  {benefit.title}
                </h3>
